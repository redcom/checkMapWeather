 ...
 *
 */
define(['views/baseView', 'templates/weatherWidget', 'models/weatherLocationCollection', 'models/flickerPictureModel', 'moment'], function(BaseView, weatherWidgetTemplate, WeatherLocationModel, FlickerPictureModel, moment) {
    var WeatherWidgetCollectionView = BaseView.extend({
        attributes: {
            id: 'weatherWidget'
        },
    ...
    return WeatherWidgetCollectionView;
});
